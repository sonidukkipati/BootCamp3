...
SET BITS=64
SET USER_JDK64_FILE=%USERPROFILE%\.IdeaIC2016.3\config\idea%BITS%.exe.jdk
SET BITS=
SET USER_JDK_FILE=%USERPROFILE%\.IdeaIC2016.3\config\idea%BITS%.exe.jdk
...
SET USER_VM_OPTIONS_FILE=%USERPROFILE%\.IdeaIC2016.3\idea%BITS%.exe.vmoptions
...
SET COMMON_JVM_ARGS="-XX:ErrorFile=%USERPROFILE%\java_error_in_IDEA_%%p.log" "-XX:HeapDumpPath=%USERPROFILE%\java_error_in_IDEA.hprof" "-Xbootclasspath/a:%IDE_HOME%/lib/boot.jar" -Didea.paths.selector=IdeaIC2016.3 %IDE_PROPERTIES_PROPERTY%
