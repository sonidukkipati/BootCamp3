...
public class AddReportExcelDataTest {
    ...
    @Test(dataProviderClass = Data_Provider.class, dataProvider = "ExcelDataProvider",enabled=false,dependsOnMethods = "setupDriver")
    ...
    @Test(dataProviderClass = Data_Provider.class, dataProvider ="givePlatformandBrowsers")
    public void setupDriver(String browser,String version,String os) throws InterruptedException, IOException {
